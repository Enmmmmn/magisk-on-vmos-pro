...
cp ./magisk32 /sbin/magisk32 > /dev/null 2>&1
[ "$IS64BIT" = true ] && cp ./magisk64 /sbin/magisk64
...
cp ./magisk32 /data/adb/magisk/magisk32 > /dev/null 2>&1
cp ./magisk64 /data/adb/magisk/magisk64 > /dev/null 2>&1
